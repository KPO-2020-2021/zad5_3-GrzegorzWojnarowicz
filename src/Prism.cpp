...
void Prism::readModelVerticesPosition() {
    std::string tmp;
    std::stringstream ss;
    int i = 0;
    std::ifstream is;
...
Prism::Prism(std::string fileNameOfModel, std::string fileNameOfBlock,
