...
void Wedge::readModelVerticesPosition() {
    std::string tmp;
    std::stringstream ss;
    int i = 0;
    std::ifstream is;
...
Wedge::Wedge(std::string fileNameOfModel, std::string fileNameOfBlock,
